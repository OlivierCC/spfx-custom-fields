              ...
              groupFields: [
                PropertyFieldCustomList('customList', {
                  ...
                  fields: [
                    ...
                    { title: 'Sub title', required: false, type: CustomListFieldType.string },
                    ...
                    { title: 'Font', required: true, type: CustomListFieldType.font, hidden: true },
                    { title: 'Font size', required: false, type: CustomListFieldType.fontSize, hidden: true },
                    { title: 'Icon', required: true, type: CustomListFieldType.icon, hidden: true },
